...
/**
 * Repräsentiert eine Anti-Aliased Linie
 * 
 * @author Denis Meyer
...
public class AntiAliasedLine extends DrawableObject {
	 ...
	 *            Punkt 2
	 */
	public AntiAliasedLine(Point p1, Point p2) {
		this.p1 = p1;
		this.p2 = p2;
	}
	...
	public AntiAliasedLine(AntiAliasedLine copy) {
		this.p1 = copy.p1;
		this.p2 = copy.p2;
	}

	/**
	 * Paint-Methode der Lineklasse. Zeichnet eine Anti-Aliased Linie
	 * 
	 * @param g
